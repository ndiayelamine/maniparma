...
class ChiSiamo{
	...
	function create(){
		...
		" SET column_position=:column_position, column_title=:column_title, column_content=:column_content, img_url_big=:img_url_big";
	...
	function update(){
		...
		$stmt->bindParam(':column_title', $this->column_title, PDO::PARAM_STR);
		$stmt->bindParam(':column_content', $this->column_content, PDO::PARAM_STR);
		$stmt->bindParam(':img_url_big', $this->img_url_big, PDO::PARAM_INT);
...
/* 	// search chi_siamo
	...
	// read chi_siamo with pagination
